<template>
    <div id="my" class="content_box f28">
        ...
        <div class='pad_10 bgfff mar_b20'>
...
<!--        </router-link>-->
        ...
        <div class='pad_10 bgfff all txt_center clear txt_centertwo'>
...
<!--        </router-link>-->
            <router-link :to="{name:'ShopMyCouponlist',params:{type:1}}" class='pad_10 all L col4 mar_b5 orderNumBox'>
                <div class='p_icon'>
                    <img src='../static/images/shop/coupon_icon.png'>
                </div>
                <div class='mar_t8 mar_15'>优惠券</div>
                <div class="couponNum" v-if="couponAmount!=0">{{couponAmount}}
                </div>
            </router-link>
        </div>
...
<script>
    ...
    export default {
        ...
        //    获取优惠券数量
            ...
            //
            jsonAjax.post(urlUtil.getApiUrl('getCustomerDiscountCouponAmount'), {
                useStatus:0,
                status:1,
                CurrentPage:1,
                customerId:that.$store.state.userinfo.userId,
                ...
                console.log(result)
                if (result.returnCode == 1) {
                    that.couponAmount = result.resultData
                }
            })
        },
        computed: {
