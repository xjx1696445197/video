        ...
        <div v-infinite-scroll="loadMore" infinite-scroll-disabled="loading" infinite-scroll-distance="10">
            <div class='pad_l20 pad_r20 bgfff mar_b20' v-for="(item,index) in orderList">
                <div class='pad_t10 pad_b10 table f24'>
                    ...
                    <div class='td wrem4 txt_right czt' v-if="item.ordersState==4&item.settlementStatus==1">待收货</div>
                    <div class='td wrem4 txt_right czt' v-if="item.ordersState<4&item.settlementStatus==1">待发货</div>
                    <div class='td wrem4 txt_right' v-if="item.ordersState==9&item.settlementStatus==1">已完成</div>
                    <div class='td wrem4 txt_right' v-if="item.ordersState==6&item.settlementStatus==0">已取消</div>
                    <div class='td wrem4 txt_right czt' v-if="item.ordersState==5&item.settlementStatus==1">待评价</div>
                    <div class='td wrem4 txt_right czt' v-if="item.ordersState==7&item.settlementStatus==1">售后中</div>
                </div>
                <div v-for="(itema,indexa) in item.productList">
                    <router-link :to="{name:'ShoporderDetail',params:{orderId:item.ordersId,type:0}}"
                ...
                <div class='pad_t10 pad_b10 txt_right f24 border_b'>
                    ...
                    <span class='c999'> (含运费{{item.freight}})</span>
                </div>
                ...
                >
                    ...
                    <div class='inblock mar_l10 com_obtn' v-if="item.ordersState==4&item.settlementStatus==1"
                    ...
                    <router-link :to="{name:'ShoporderEvaluate',params:{orderId:item.ordersId,type:1}}"
                                 class='inblock mar_l10 com_obtn' v-if="item.ordersState==5&item.settlementStatus==1"
                    >
                        去评价
                    </router-link>
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                tabIndex: this.$route.params.type || 1,//1全部，2待付款，3待发货，4待收货
