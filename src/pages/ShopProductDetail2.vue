<template>
    ...
    <div id="productDetail" class="content_box">
        ...
        <div class='all bgfff pad_20 table'>
            <div class='td f28 all pad_r20' style="width: 75%">{{baseInfo.productName}}</div>
            <span class="copy-btn" v-clipboard:copy="baseInfo.productName" v-clipboard:success="onCopy" v-clipboard:error="onError" style="color:#e4811d;">复制去咨询</span>
        </div>
        ...
        <div class='pad_l20 pad_r20 mar_b10 bgfff'>
        ...
        <div class='bgfff pad_t20 pad_b20 detail_cnt' style='min-height:4rem;' v-if="xq_zt==0">
            <div v-if="tabIndex==0">
                <!--详情  -->
        ...
        <div class='box_guige' :class='guigeOprate!=0?"cur":""'>
            ...
            <div class='scrolla'>
                <div v-for="(item,index) in productGuige">
                    ...
                    <div class='clear pad_10 border_b' style="height: 1rem">
