				...
				<div class="realName_list">
					...
					<div class="realName_item">
						<div class="INPUT_REAL clearfix">
							...
							<select
									...
									class="realName_select realName_select2 fr">
					...
					<div class="realName_item_wrapper2" v-if="showCode==2">
						...
						<div class="realName_item">
							...
							<div class="INPUT_REAL" style="border: none;height: 0.6rem;">
								<p class="realName_txt3" style="margin-top: 0.3rem;">港澳居民来往内地通行证</p>

								<!--<input type="text" class="realName_input"
                                       v-validate:usercards="validateOtions.usercards"
                                       placeholder="请输入您的身份证号码(括号用英文)"
						...
						<div class="realName_item">
							...
							<div class="INPUT_REAL">
								<!--<p class="realName_txt3">港澳居民来往内地通行证</p>-->

								<input type="text" class="realName_input"
									   v-validate:usercards="validateOtions.usercards"
									   placeholder="请输入您的身份证号码(带括号的用英文括号)"
									   v-model="formData.usercards"
								>
							</div>
						</div>
					...
					<div class="realName_item_wrapper3" v-if="showCode==3">
						...
						<div class="realName_item">
							<div class="INPUT_REAL" style="border: none;height: 0.6rem;">
								<p class="realName_txt3" style="margin-top: 0.3rem;">台湾居民来往内地通行证</p>
							</div>
...
//
						var rex = /^[a-zA-Z]{1,2}\d{6,10}\([0-9a-zA-Z]\)$|^[1|5|7][0-9]{6}[0-9A-Z]$/;
					}else{
...
//		            	this.showTips('正确'+this.formData.usercards)
					}
				}
//				return
				// 通行证正确 验证省市县
