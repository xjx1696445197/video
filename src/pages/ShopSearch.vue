<template>
    <div class="page">
        <div class="HEADER_SHOP">
            <div class="HEADER_SHOP_BACK" @click="close()"></div>
        ...
        <div class="wrapper">
            ...
            <div class='pad_20 bgfff'>
                ...
                <div class='mar_b20 f30 pad_b20'>最近搜索</div>
                <div class='c666 mar_b20 pad_b20 f28'>
                    <div class='search_vv' v-for="item in searchList" v-on:click='searchBtn(item)'>{{item}}</div>
                </div>
                <div class='pad_t20 f28 txt_center pad_b20' v-if="searchList.length>0">
                    <div class='delete_btn inblock' v-on:click='deleteSearch'>
                        <span class='inblock'>清空历史记录</span>
                    </div>
                </div>
            </div>
        ...
        methods: {
            ...
            queryProduct(){
                ...
                if(this.searchTxt){
                    ...
                    this.$router.push({name:"ShopProduct",params:{cId:0,cName:0,keyword:this.searchTxt}});
                    // this.$push({path:"shopProduct",query:{cId:0,cName:0,keyword:this.searchTxt}});
                }else{
                    this.showTips("请输入您想要搜索的商品！")
                }
            },
            // 不修改
            cancelTxt(){
...
<style scoped>
    ...
    .delete_btn {
        padding: 0.16rem 0.8rem 0.2rem 0.8rem;
