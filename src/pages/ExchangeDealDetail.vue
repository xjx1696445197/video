            ...
            <div class="content">
                <div class="main">
                    ...
                    >
                        ...
                        <p class="detail_txt1">{{dealFlag}}{{(detail.xmb + detail.xmbLock) | tofixed4}}{{currencyName=='CHMC'?'':'CHMC'}}</p>
                        <p class="detail_txt2">{{currencyName}} 兑换成功</p>
                    </div>

                    <div class="detail_list">
                        <div class="detail_item">
                            <p class="detail_item_txt1">消耗{{currencyName=='CHMC'?'积分':currencyName}}</p>
                            <p class="detail_item_txt2">{{detail.pay}}</p>
                        </div>
                        <div class="detail_item">
                            <p class="detail_item_txt1">获得流通CHMC</p>
                            <p class="detail_item_txt2">{{detail.xmb}}</p>
                        </div>
                        <div class="detail_item">
                            <p class="detail_item_txt1">获得封藏CHMC</p>
                            <p class="detail_item_txt2">{{detail.xmbLock}}</p>
                        </div>
                        <div class="detail_item">
                            <p class="detail_item_txt1">{{$t('currencyDetail.currencyDetail_fee')}}</p>
                            <p class="detail_item_txt2">{{String(detail.serviceCharge) || '------'}}</p>
                        </div>
                        <!--<div class="detail_item">
                            <p class="detail_item_txt1">{{$t('currencyDetail.currencyDetail_block')}}</p>
                            <p class="detail_item_txt2">{{detail.blockNumber || '------'}}</p>
                        </div>-->
                        <div class="detail_item">
                        ...
                        <!--<div class="detail_item">
                            ...
                            <p class="detail_item_txt2">{{detail.hash || '------'}}</p>
                        </div>-->
                    </div>
                </div>
            </div>
